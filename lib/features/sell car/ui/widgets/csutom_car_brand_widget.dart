...
class CsutomCarBrandWidget extends StatefulWidget {
  const CsutomCarBrandWidget({super.key, required this.onBrandSelected});

  final ValueChanged<String> onBrandSelected;

  @override
  State<CsutomCarBrandWidget> createState() => _CsutomCarBrandWidgetState();
}

class _CsutomCarBrandWidgetState extends State<CsutomCarBrandWidget> {
